...
10. **動態模板建立**：上傳真實的 Excel/Word 定檢表，系統透過 AI + 規則引擎自動分析文件結構，產生標準化的 InspectionTemplate JSON 模板，免去手動定義模板的繁瑣工作。支援欄位智慧分類、單位自動偵測、原始文件綁定等功能。
...
| [test_forms/TEST_REPORT.md](test_forms/TEST_REPORT.md) | 動態模板建立功能測試報告 |